...
poetry run python get_segments.py
...
# poetry run python cli.py --sid 0 --eid 500 --ptype glitch --samplenum 55
# poetry run python cli.py --sid 500 --eid 1000 --samplenum 500 --ptype background
# poetry run python cli.py --sid 1000 --eid 1500 --ptype injection --itype bbh --samplenum 55
