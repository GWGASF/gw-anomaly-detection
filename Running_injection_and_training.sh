...
python /opt/repo/gw-anomaly-detection/cli.py --sid 0 --eid 500 --pype glitch
python /opt/repo/gw-anomaly-detection/cli.py --sid 500 --eid 1000 --ptype noise
...
python /opt/repo/gw-anomaly-detection/cli.py --sid 2000 --eid 2500 --ptype test --itype lfsg
